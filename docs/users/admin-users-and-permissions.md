...
!!! important "Rate Limiting & Stability"
    The rate limit is **120 requests per minute**. User and permission changes should be serialized per user. Avoid parallel role and rights document updates for the same user because the final effective permission set can be difficult to audit.
