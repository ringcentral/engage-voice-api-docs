...
<div class="card-deck">
  <div class="card" style="width: 18rem;">
    <div class="card-body pt-0 pb-0">
      <h5 class="card-title">Dial Groups</h5>
  ...
  <div class="card" style="width: 18rem;">
    <div class="card-body pt-0 pb-0">
      ...
      <p class="card-text">Campaigns are a way to organize and manage the different types of outbound calls leaving your contact center. You can configure campaigns by creating custom agent dispositions, uploading lead lists, setting schedules for dialing, activating compliance-supporting tools, and more.</p>
      <ul class="pl-0 ml-4">
  ...
  <div class="card" style="width: 18rem;">
    <div class="card-body pt-0 pb-0">
      ...
      <p class="card-text">Leads are arranged into lead lists and uploaded into campaigns for agents to dial on.</p>
      <ul class="pl-0 ml-4">
